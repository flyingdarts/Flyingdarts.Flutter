...
void main() {
  ...
  group('Happy flow scenarios: ', () {
    ...
    blocTest<SpeechBloc, SpeechState>('When button is pressed and received an expected result',
    ...
    blocTest<SpeechBloc, SpeechState>('When button is pressed and received an unexpected result',
        build: () => speechBloc = SpeechBloc()..init(),
        act: (bloc) => {
          bloc.add(const SpeechButtonLongPressed()),
