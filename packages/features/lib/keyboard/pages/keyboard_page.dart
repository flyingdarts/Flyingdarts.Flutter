...
import 'package:flyingdarts_features/keyboard/widgets/keyboard_button.dart';
      ...
      for (var key in row) {
        buttons.add(
          KeyboardButton(
            ...
            disabled: [1, 2, 3, 4, 5, 6, 7, 8, 9].contains(key) ? cubit.state.shouldDisableNumpad : cubit.state.shouldDisableShortcuts,
          ),
        );
      }
      rows.add(
