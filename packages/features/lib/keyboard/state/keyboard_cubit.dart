...
import 'package:flyingdarts_features/keyboard/state/keyboard_state.dart';
...
class KeyboardCubit extends Cubit<KeyboardState> {
  ...
  void clear() {
    emit(
      state.copyWith(lastInput: 0, shouldDisableNumpad: false, shouldDisableShortcuts: false, shouldDisableFunctions: true),
    );
  }
